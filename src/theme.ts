...
export const THEMES: Record<ThemeMode, ThemeConfig> = {
  museum: {
    ...
    colors: {
      bg: 'bg-[#F9F7F2]',
      text: 'text-[#1A1A1A]',
      textMuted: 'text-[#7A756D]',
      accent: 'text-[#A52A2A]',
      accentBg: 'bg-[#A52A2A]',
      border: 'border-[#D1CEC7]',
      borderHeavy: 'border-[#1A1A1A]',
      paperBg: 'bg-white',
    },
    typography: {
      fontBody: 'font-serif',
      ...
      watermark: 'font-serif font-black text-[#A52A2A]/5 italic',
    },
    layout: {
      docContainer: 'bg-white border-double border-[6px] border-[#D1CEC7] relative shadow-sm',
      sidebarActive: 'bg-[#EFECE6]',
      sidebarHover: 'hover:bg-[#EFECE6]/50',
    },
    interactive: {
